...
export function createOmniHttpHandler({ hub, storage, assertAuthenticated, readJson, readStateEnvelope, saveState, json } = {}) {
  if (!hub || !assertAuthenticated || !readJson || !json) throw new TypeError('Dependências Omni obrigatórias.');
