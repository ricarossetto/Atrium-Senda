...
function renderAutosAction(item, escapeHtml) {
  ...
  return `
    ...
    <div class="process-autos-action">
      <div>
        <strong>Caderno processual para consulta offline (Snapshot)</strong>
        <span>Gera PDFs derivados do snapshot público (resumo dos andamentos). Não contém as peças anexas originais.</span>
      </div>
