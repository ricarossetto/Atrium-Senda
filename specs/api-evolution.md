...
- **Identidade do primeiro responsável**: o primeiro acesso separa a criação da conta da configuração profissional. Nome, e-mail, usuário e senha ficam na primeira etapa; OAB e UF são opcionais e aparecem em uma segunda etapa. A ativação do monitoramento judicial exige OAB + UF e consentimento explícito. Esses campos integram o perfil local cifrado; somente quando o monitoramento é aceito a identidade profissional alimenta o termo principal do Store e autoriza as sincronizações automáticas.
