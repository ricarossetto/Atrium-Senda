...
const checkFiles = [
  ...
  'tests/ui_v2_links.mjs',
  'tests/ui_v2_links_accessibility.mjs',
  'tests/visual_ui_v2_links.mjs',
  ...
  'tests/managed_judicial_connectivity.mjs',
  'tests/spec_contracts.mjs',
  ...
  'tests/ui_v2_iconography.mjs',
  'tests/ui_v2_iconography_semantics.mjs',
  'tests/ui_v2_iconography_accessibility.mjs',
  'tests/visual_ui_v2_iconography.mjs',
  'tests/ui_v2_global_polish.mjs',
  'tests/ui_v2_global_polish_accessibility.mjs',
  'tests/visual_ui_v2_global_polish.mjs',
  'tests/ui_v2_final_parity.mjs',
  'tests/ui_v2_final_accessibility.mjs',
  'tests/ui_v2_runtime_hygiene.mjs',
  'tests/visual_ui_v2_final_rollout.mjs',
...
const testSuites = [
  ...
  { name: 'Managed Judicial Connectivity, Sessões, Backoff, Matching e Read-Only', file: 'tests/managed_judicial_connectivity.mjs' },
  { name: 'Especificações Canônicas do Produto e Guidance Agentivo', file: 'tests/spec_contracts.mjs' },
  ...
  { name: 'UI V2 Links, Referências Estáticas e Contratos Canônicos', file: 'tests/ui_v2_links.mjs' },
  { name: 'UI V2 Links, Acessibilidade e Recursos Responsivos', file: 'tests/ui_v2_links_accessibility.mjs' },
  { name: 'UI V2 Links, Visual QA e Contenção do Catálogo', file: 'tests/visual_ui_v2_links.mjs' },
  ...
  { name: 'Gate Documental de Readiness Técnico e Migração UI V2 Concluída', file: 'tests/beta_readiness_gate.mjs' },
  { name: 'UI V2 Iconografia, Sprite Local e Inventário Controlado', file: 'tests/ui_v2_iconography.mjs' },
  { name: 'UI V2 Iconografia, Registry e Distinções Semânticas', file: 'tests/ui_v2_iconography_semantics.mjs' },
  { name: 'UI V2 Iconografia, Acessibilidade e Targets Responsivos', file: 'tests/ui_v2_iconography_accessibility.mjs' },
  { name: 'UI V2 Iconografia, Visual QA e Coerência Mineral Editorial', file: 'tests/visual_ui_v2_iconography.mjs' },
  { name: 'UI V2 Global Polish, Materiais e Hierarquia Mineral Editorial', file: 'tests/ui_v2_global_polish.mjs' },
  { name: 'UI V2 Global Polish, Acessibilidade e Reflow Responsivo', file: 'tests/ui_v2_global_polish_accessibility.mjs' },
  { name: 'UI V2 Global Polish, Matriz Visual e Contenção', file: 'tests/visual_ui_v2_global_polish.mjs' },
  { name: 'UI V2 Final Parity e Autoridade Canônica', file: 'tests/ui_v2_final_parity.mjs' },
  { name: 'UI V2 Final Accessibility, Reflow e Reduced Motion', file: 'tests/ui_v2_final_accessibility.mjs' },
  { name: 'UI V2 Runtime Hygiene em Ciclos Repetidos', file: 'tests/ui_v2_runtime_hygiene.mjs' },
  { name: 'UI V2 Final Rollout Visual QA', file: 'tests/visual_ui_v2_final_rollout.mjs' },
