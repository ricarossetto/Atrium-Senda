...
const checkFiles = [
  ...
  'lib/judicial/tjrs-monitoring.mjs',
  'lib/publications/publication-workflow.mjs',
  'lib/dav/dav-integration-service.mjs',
  'lib/api/api-contract.mjs',
  ...
  'scripts/generate-release-screenshots.mjs',
  'js/auth.js',
  'js/portal.js',
  'js/app/bootstrap.js',
  'js/core/api.js',
  'js/core/store.js',
  'js/core/legal-timeline.js',
  'js/core/client-context.js',
  ...
  'tests/tjrs_sidecar_integration.mjs',
  'tests/decision_html_and_access_key.mjs',
  'tests/tjrs_sidecar_fallback.mjs',
  'tests/eproc_a1_totp_integration.mjs',
  'tests/publication_link_search.mjs',
  'tests/task_link_search.mjs',
  'tests/process_task_creation.mjs',
  'tests/task_management_modes.mjs',
  'tests/publication_task_linking.mjs',
  'tests/publication_workflow.mjs',
  'tests/activity_inbox.mjs',
  'tests/legal_timeline.mjs',
  'tests/client_context.mjs',
  'tests/document_type_ids.mjs',
  'tests/documents_feature.mjs',
  'lib/documents/document-storage-provider.mjs',
  'tests/document_storage_provider.mjs',
  'tests/document_storage.mjs',
  'tests/ui_v2_document_storage.mjs',
  'tests/assistant_feature.mjs',
  'tests/prompts_feature.mjs',
  'tests/configuration_feature.mjs',
  'tests/large_state_persistence.mjs',
  'tests/core_legal_workflow_reliability.mjs',
  'tests/dav_integration_foundation.mjs',
  'tests/api_evolution_foundation.mjs',
  'tests/product_maturity_baseline.mjs',
  ...
  'lib/documents/document-service.mjs',
  'lib/documents/document-intelligence.mjs',
  'lib/documents/document-metadata.mjs',
  ...
  'tests/fresh_install_product_completion.mjs',
  'tests/cross_module_navigation.mjs',
  'tests/ui_v2_motion.mjs',
  'tests/visual_product_completion_motion.mjs',
  ...
  'tests/document_intelligence.mjs',
  'tests/document_metadata.mjs',
  'tests/ui_v2_document_intelligence.mjs',
  'tests/ui_v2_document_metadata.mjs',
  'tests/visual_ui_v2_documents.mjs',
  'tests/full_text_search.mjs',
  'tests/ui_v2_full_text_search.mjs',
  'tests/visual_ui_v2_full_text_search.mjs',
  ...
  'tests/visual_post_baseline_hardening.mjs',
  'tests/visual_human_acceptance.mjs',
  ...
  'tests/windows_launcher_contract.mjs',
  'tests/stable_release_contract.mjs',
  ...
  'tests/ui_v2_client_context.mjs',
...
const testSuites = [
  ...
  { name: 'Migrações Seguras da Chave IA e Feedback Local Cifrado', file: 'tests/security_migrations.mjs' },
  ...
  { name: 'Integração Local do Sidecar TJRS, Reconciliação e Idempotência', file: 'tests/tjrs_sidecar_integration.mjs' },
  { name: 'HTML Judicial, Chave de Acesso, Monitoramento e Caderno PDF', file: 'tests/decision_html_and_access_key.mjs' },
  { name: 'Fallback do Sidecar TJRS para Omni e Caderno PDF sem Snapshot', file: 'tests/tjrs_sidecar_fallback.mjs' },
  { name: 'Integração Eproc TJRS (mTLS Keycloak, 2FA TOTP Híbrido e Download de Autos)', file: 'tests/eproc_a1_totp_integration.mjs' },
  { name: 'Busca Contextual de Processo e Cliente na Publicação', file: 'tests/publication_link_search.mjs' },
  { name: 'Busca Contextual de Processo e Cliente na Tarefa', file: 'tests/task_link_search.mjs' },
  { name: 'Criação de Tarefa Vinculada pelo Inspetor do Processo', file: 'tests/process_task_creation.mjs' },
  { name: 'Gestão de Tarefas em Lista e Kanban', file: 'tests/task_management_modes.mjs' },
  { name: 'Vínculo transacional entre Publicações e Tarefas', file: 'tests/publication_task_linking.mjs' },
  { name: 'Publicação para Providências Rastreáveis e Supervisionadas', file: 'tests/publication_workflow.mjs' },
  { name: 'Activity Inbox Derivada, Priorização e Deduplicação', file: 'tests/activity_inbox.mjs' },
  { name: 'Linha do Tempo Jurídica Derivada e Navegável', file: 'tests/legal_timeline.mjs' },
  { name: 'Contexto Jurídico Derivado do Contato sem Inferência por Nome', file: 'tests/client_context.mjs' },
  ...
  { name: 'Abstração de Storage Documental, Provider Local Cifrado e Atomicidade', file: 'tests/document_storage_provider.mjs' },
  { name: 'Núcleo Documental, Naming, Deduplicação, Lixeira e Criptografia', file: 'tests/document_storage.mjs' },
  { name: 'Inteligência Documental, Preview Inerte, OCR Local e PDF Derivado', file: 'tests/document_intelligence.mjs' },
  { name: 'Metadados Documentais, Tags, Entidades e Relações Supervisionadas', file: 'tests/document_metadata.mjs' },
  { name: 'Busca Full-Text Derivada, OCR, Ranking e Rebuild Seguro', file: 'tests/full_text_search.mjs' },
  ...
  { name: 'Persistência de Estado Grande sem Limite de Fetch Keepalive', file: 'tests/large_state_persistence.mjs' },
  { name: 'Confiabilidade do Fluxo Jurídico Real: Estado, Concorrência e Cobertura', file: 'tests/core_legal_workflow_reliability.mjs' },
  { name: 'DAV Integration Foundation, Cofre, SSRF e Transporte Experimental', file: 'tests/dav_integration_foundation.mjs' },
  { name: 'API Evolution Foundation, Metadata, Compatibilidade e Fronteira Privada', file: 'tests/api_evolution_foundation.mjs' },
  { name: 'Consolidação Final de Maturidade, Verdade Documental e Clean-Room', file: 'tests/product_maturity_baseline.mjs' },
  { name: 'Inteligência Cadastral Brasileira, Provedores, Cache e Segurança', file: 'tests/registry_intelligence.mjs' },
  { name: 'UI V2 Inteligência Cadastral, Revisão e QSA Supervisionados', file: 'tests/ui_v2_registry_intelligence.mjs' },
  { name: 'Primeiro Dia Sintético, Empty State, CRUD e Persistência', file: 'tests/fresh_install_product_completion.mjs' },
  { name: 'Navegação Canônica entre Processo, Publicação, Contato e Tarefa', file: 'tests/cross_module_navigation.mjs' },
  { name: 'UI V2 Motion Mineral Editorial e Reduced Motion', file: 'tests/ui_v2_motion.mjs' },
  { name: 'Product Completion, Registry e Motion Visual QA', file: 'tests/visual_product_completion_motion.mjs' },
  ...
  { name: 'Diagnóstico do Sistema, Backups Criptografados & Feedback Local', file: 'tests/system_diagnostic.mjs' },
  ...
  { name: 'UI V2 Acervo Documental, Ownership, Lixeira e Naming', file: 'tests/ui_v2_document_storage.mjs' },
  { name: 'UI V2 Inteligência Documental, OCR Supervisionado e PDF Seguro', file: 'tests/ui_v2_document_intelligence.mjs' },
  { name: 'UI V2 Organização e Metadados Documentais', file: 'tests/ui_v2_document_metadata.mjs' },
  { name: 'UI V2 Busca Global Full-Text, Segurança e Navegação', file: 'tests/ui_v2_full_text_search.mjs' },
  { name: 'UI V2 Busca Global Full-Text, Visual QA e Responsividade', file: 'tests/visual_ui_v2_full_text_search.mjs' },
  ...
  { name: 'Hardening Pós-Baseline: Notificações, Sidebar, Onboarding e CRM', file: 'tests/visual_post_baseline_hardening.mjs' },
  { name: 'Human Visual Acceptance: Matriz A–U e Interações Reabertas', file: 'tests/visual_human_acceptance.mjs' },
  ...
  { name: 'Inicializador Windows Estável, Idempotente e Não Destrutivo', file: 'tests/windows_launcher_contract.mjs' },
  { name: 'Contrato Público da Release Estável ATRIUM 2.0.0', file: 'tests/stable_release_contract.mjs' },
  ...
  { name: 'UI V2 Client 360 e Navegação Relacional', file: 'tests/ui_v2_client_context.mjs' },
