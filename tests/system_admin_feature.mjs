...
const diagnostic = {
  ...
  integrations: {
    djen: { status: 'consulta_sob_demanda', description: 'DJEN sintético' }, datajud: { status: 'configurado' },
    gemini: { status: 'nao_configurado' }, collector: { lastRun: null }
  },
  runtime: { status: 'READY', recoveryDetails: null, fileExists: true, lastRuntimeUpdate: null }
};
