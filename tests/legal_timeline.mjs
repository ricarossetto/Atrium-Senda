...
const process = {
  ...
  movements: [{ id: 'movement-one', date: '2026-08-30T10:00:00.000Z', description: 'Movimentação sintética', source: 'DJEN / CNJ Oficial + DataJud / CNJ + DJEN / CNJ Oficial + DataJud / CNJ' }],
...
assert.equal(timeline.find(event => event.id.startsWith('movement:')).source, 'DJEN / CNJ Oficial + DataJud / CNJ', 'Origem composta não pode crescer com rótulos repetidos.');
