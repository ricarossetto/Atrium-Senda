...
try {
  ...
  await page.evaluate(() => {
    ...
    window.Atrium.Store.state.intimations = [
      ...
      { id: 'int-demo-2', title: 'Movimentação processual aguardando análise', process: '5000001-00.2026.4.04.0000', client: 'Cliente Sintético Dois', court: 'TRF Sintético', publishedAt, text: 'Movimentação processual aguardando análise para conferência.', unread: true, treatmentStatus: 'untreated' }
    ];
